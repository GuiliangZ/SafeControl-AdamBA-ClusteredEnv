...
class TD3():
    ...
    def __init__(
        ...
        self.actor_target.compile(optimizer='rmsprop', loss='categorical_crossentropy')
        self.actor_target.set_weights(self.actor.get_weights())
        self.actor_optimizer = keras.optimizers.Adam(learning_rate=3e-4)
        self.critic = Critic()
        self.critic_target = self.critic
        self.critic_target.compile(optimizer='rmsprop', loss='categorical_crossentropy')
    ...
    def parameter_explore(self):
        self.expl_policy_actor = self.actor
        self.expl_policy_actor.compile(optimizer='rmsprop', loss='categorical_crossentropy')
        self.expl_policy_actor.set_weights(self.actor.get_weights())                                        
